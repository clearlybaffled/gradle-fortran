...
class FortranEnabledGccPlatformToolProvider extends AbstractPlatformToolProvider {
    ...
    protected Compiler<FortranCompileSpec> createFortranCompiler() {
        GccCommandLineToolConfigurationInternal compilerTool = toolRegistry.getTool(ToolType.FORTRAN_COMPILER)
        ...
        versionAwareCompiler(outputCleaningCompiler, ToolType.FORTRAN_COMPILER)
    }
